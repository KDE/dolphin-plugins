    ...
    , m_retrievalHgw(nullptr)
{
    ...
    m_addAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Add"));
    connect(m_addAction, &QAction::triggered, this, &FileViewHgPlugin::addFiles);

    m_removeAction = new QAction(this);
    m_removeAction->setIcon(QIcon::fromTheme(QStringLiteral("list-remove")));
    m_removeAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Remove"));
    connect(m_removeAction, &QAction::triggered, this, &FileViewHgPlugin::removeFiles);

    m_renameAction = new QAction(this);
    m_renameAction->setIcon(QIcon::fromTheme(QStringLiteral("list-rename")));
    m_renameAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Rename"));
    connect(m_renameAction, &QAction::triggered, this, &FileViewHgPlugin::renameFile);

    m_commitAction = new QAction(this);
    m_commitAction->setIcon(QIcon::fromTheme(QStringLiteral("vcs-commit")));
    m_commitAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Commit"));
    connect(m_commitAction, &QAction::triggered, this, &FileViewHgPlugin::commit);

    m_tagAction = new QAction(this);
    m_tagAction->setIcon(QIcon::fromTheme(QStringLiteral("svn-tag")));
    m_tagAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Tag"));
    connect(m_tagAction, &QAction::triggered, this, &FileViewHgPlugin::tag);

    m_branchAction = new QAction(this);
    m_branchAction->setIcon(QIcon::fromTheme(QStringLiteral("vcs-branch")));
    m_branchAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Branch"));
    connect(m_branchAction, &QAction::triggered, this, &FileViewHgPlugin::branch);

    m_cloneAction = new QAction(this);
    m_cloneAction->setIcon(QIcon::fromTheme(QStringLiteral("hg-clone")));
    m_cloneAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Clone"));
    connect(m_cloneAction, &QAction::triggered, this, &FileViewHgPlugin::clone);

    m_createAction = new QAction(this);
    m_createAction->setIcon(QIcon::fromTheme(QStringLiteral("hg-create")));
    m_createAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Init"));
    connect(m_createAction, &QAction::triggered, this, &FileViewHgPlugin::create);

    m_updateAction = new QAction(this);
    m_updateAction->setIcon(QIcon::fromTheme(QStringLiteral("vcs-pull")));
    m_updateAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Update"));
    connect(m_updateAction, &QAction::triggered, this, &FileViewHgPlugin::update);

    m_globalConfigAction = new QAction(this);
    m_globalConfigAction->setIcon(QIcon::fromTheme(QStringLiteral("hg-config")));
    m_globalConfigAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Global Config"));
    connect(m_globalConfigAction, &QAction::triggered, this, &FileViewHgPlugin::global_config);

    m_repoConfigAction = new QAction(this);
    m_repoConfigAction->setIcon(QIcon::fromTheme(QStringLiteral("hg-config")));
    m_repoConfigAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Repository Config"));
    connect(m_repoConfigAction, &QAction::triggered, this, &FileViewHgPlugin::repo_config);

    m_pushAction = new QAction(this);
    m_pushAction->setIcon(QIcon::fromTheme(QStringLiteral("vcs-push")));
    m_pushAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Push"));
    connect(m_pushAction, &QAction::triggered, this, &FileViewHgPlugin::push);

    m_pullAction = new QAction(this);
    m_pullAction->setIcon(QIcon::fromTheme(QStringLiteral("vcs-pull")));
    m_pullAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Pull"));
    connect(m_pullAction, &QAction::triggered, this, &FileViewHgPlugin::pull);

    m_revertAction = new QAction(this);
    m_revertAction->setIcon(QIcon::fromTheme(QStringLiteral("document-revert")));
    m_revertAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Revert"));
    connect(m_revertAction, &QAction::triggered, this, &FileViewHgPlugin::revert);

    m_revertAllAction = new QAction(this);
    m_revertAllAction->setIcon(QIcon::fromTheme(QStringLiteral("document-revert")));
    m_revertAllAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Revert All"));
    connect(m_revertAllAction, &QAction::triggered, this, &FileViewHgPlugin::revertAll);

    m_rollbackAction = new QAction(this);
    m_rollbackAction->setIcon(QIcon::fromTheme(QStringLiteral("hg-rollback")));
    m_rollbackAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Rollback"));
    connect(m_rollbackAction, &QAction::triggered, this, &FileViewHgPlugin::rollback);

    m_mergeAction = new QAction(this);
    m_mergeAction->setIcon(QIcon::fromTheme(QStringLiteral("vcs-merge")));
    m_mergeAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Merge"));
    connect(m_mergeAction, &QAction::triggered, this, &FileViewHgPlugin::merge);

    m_bundleAction = new QAction(this);
    m_bundleAction->setIcon(QIcon::fromTheme(QStringLiteral("hg-bundle")));
    m_bundleAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Bundle"));
    connect(m_bundleAction, &QAction::triggered, this, &FileViewHgPlugin::bundle);

    m_exportAction = new QAction(this);
    m_exportAction->setIcon(QIcon::fromTheme(QStringLiteral("hg-export")));
    m_exportAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Export"));
    connect(m_exportAction, &QAction::triggered, this, &FileViewHgPlugin::exportChangesets);

    m_importAction = new QAction(this);
    m_importAction->setIcon(QIcon::fromTheme(QStringLiteral("hg-import")));
    m_importAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Import"));
    connect(m_importAction, &QAction::triggered, this, &FileViewHgPlugin::importChangesets);

    m_unbundleAction = new QAction(this);
    m_unbundleAction->setIcon(QIcon::fromTheme(QStringLiteral("hg-unbundle")));
    m_unbundleAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Unbundle"));
    connect(m_unbundleAction, &QAction::triggered, this, &FileViewHgPlugin::unbundle);

    m_serveAction = new QAction(this);
    m_serveAction->setIcon(QIcon::fromTheme(QStringLiteral("hg-serve")));
    m_serveAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Serve"));
    connect(m_serveAction, &QAction::triggered, this, &FileViewHgPlugin::serve);

    m_backoutAction = new QAction(this);
    m_backoutAction->setIcon(QIcon::fromTheme(QStringLiteral("hg-backout")));
    m_backoutAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Backout"));
    connect(m_backoutAction, &QAction::triggered, this, &FileViewHgPlugin::backout);

    m_diffAction = new QAction(this);
    m_diffAction->setIcon(QIcon::fromTheme(QStringLiteral("vcs-diff")));
    m_diffAction->setText(xi18nc("@action:inmenu", "<application>Hg</application> Diff"));
    connect(m_diffAction, &QAction::triggered, this, &FileViewHgPlugin::diff);
    ...
    m_menuAction->setText(xi18nc("@action:inmenu", "<application>Mercurial</application>"));
...
void FileViewHgPlugin::createHgWrapper() const
{
    ...
    connect(m_hgWrapper, &HgWrapper::primaryOperationFinished, this, &FileViewHgPlugin::slotOperationCompleted);
    connect(m_hgWrapper, &HgWrapper::primaryOperationError, this, &FileViewHgPlugin::slotOperationError);
}
...
QList<QAction *> FileViewHgPlugin::itemContextMenu(const KFileItemList &items) const
{
    ...
    if (!m_hgWrapper->isBusy()) {
        ...
        m_diffAction->setEnabled(revertableCount == items.count() && items.size() == 1);
        m_renameAction->setEnabled(items.size() == 1 && itemVersion(items.first()) != UnversionedVersion);
    } else {
...
void FileViewHgPlugin::addFiles()
{
    ...
    QString infoMsg = xi18nc("@info:status", "Adding files to <application>Hg</application> repository...");
    m_errorMsg = xi18nc("@info:status", "Adding files to <application>Hg</application> repository failed.");
    m_operationCompletedMsg = xi18nc("@info:status", "Added files to <application>Hg</application> repository.");
...
void FileViewHgPlugin::removeFiles()
{
    ...
    QString infoMsg = xi18nc("@info:status", "Removing files from <application>Hg</application> repository...");
    m_errorMsg = xi18nc("@info:status", "Removing files from <application>Hg</application> repository failed.");
    m_operationCompletedMsg = xi18nc("@info:status", "Removed files from <application>Hg</application> repository.");
...
void FileViewHgPlugin::renameFile()
{
    ...
    m_errorMsg = xi18nc("@info:status", "Renaming of file in <application>Hg</application> repository failed.");
    m_operationCompletedMsg = xi18nc("@info:status", "Renamed file in <application>Hg</application> repository successfully.");
    Q_EMIT infoMessage(xi18nc("@info:status", "Renaming file in <application>Hg</application> repository."));
...
void FileViewHgPlugin::commit()
{
    ...
    m_errorMsg = xi18nc("@info:status", "Commit to <application>Hg</application> repository failed.");
    m_operationCompletedMsg = xi18nc("@info:status", "Committed to <application>Hg</application> repository.");
    Q_EMIT infoMessage(xi18nc("@info:status", "Commit <application>Hg</application> repository."));
...
{
    m_errorMsg = xi18nc("@info:status", "Tag operation in <application>Hg</application> repository failed.");
    m_operationCompletedMsg = xi18nc("@info:status", "Tagging operation in <application>Hg</application> repository is successful.");
    Q_EMIT infoMessage(xi18nc("@info:status", "Tagging operation in <application>Hg</application> repository."));
...
{
    m_errorMsg = xi18nc("@info:status", "Update of <application>Hg</application> working directory failed.");
    m_operationCompletedMsg = xi18nc("@info:status", "Update of <application>Hg</application> working directory is successful.");
    Q_EMIT infoMessage(xi18nc("@info:status", "Updating <application>Hg</application> working directory."));
...
{
    m_errorMsg = xi18nc("@info:status", "Branch operation on <application>Hg</application> repository failed.");
    m_operationCompletedMsg = xi18nc("@info:status", "Branch operation on <application>Hg</application> repository completed successfully.");
    Q_EMIT infoMessage(xi18nc("@info:status", "Branch operation on <application>Hg</application> repository."));
...
void FileViewHgPlugin::revert()
{
    ...
    int answer = KMessageBox::questionTwoActions(nullptr,
                                                 ...
                                                 i18n("Revert"),
                                                 KGuiItem(i18n("Revert")),
                                                 KStandardGuiItem::cancel());
    if (answer == KMessageBox::ButtonCode::SecondaryAction) {
        return;
    }

    QString infoMsg = xi18nc("@info:status", "Reverting files in <application>Hg</application> repository...");
    m_errorMsg = xi18nc("@info:status", "Reverting files in <application>Hg</application> repository failed.");
    m_operationCompletedMsg = xi18nc("@info:status", "Reverting files in <application>Hg</application> repository completed successfully.");
...
{
    QString infoMsg = xi18nc("@info:status", "Generating diff for <application>Hg</application> repository...");
    m_errorMsg = xi18nc("@info:status", "Could not get <application>Hg</application> repository diff.");
    m_operationCompletedMsg = xi18nc("@info:status", "Generated <application>Hg</application> diff successfully.");
...
void FileViewHgPlugin::backout()
{
    ...
    m_hgWrapper = HgWrapper::instance();
    if (!m_hgWrapper->isWorkingDirectoryClean()) {
        KMessageBox::error(nullptr, xi18nc("@message:error", "abort: Uncommitted changes in working directory!"));
        return;
    }
...
void FileViewHgPlugin::rollback()
{
    ...
    // ask
    int answer = KMessageBox::questionTwoActions(nullptr,
                                                 xi18nc("@message:yesorno", "Would you like to rollback last transaction?") + QLatin1String("\nrevision: ")
                                                     + lastTransaction,
                                                 i18n("Rollback"),
                                                 KGuiItem(i18n("Rollback")),
                                                 KStandardGuiItem::cancel());
    if (answer == KMessageBox::ButtonCode::SecondaryAction) {
        return;
    }

    QString infoMsg = xi18nc("@info:status", "Executing Rollback <application>Hg</application> repository...");
    m_errorMsg = xi18nc("@info:status", "Rollback of <application>Hg</application> repository failed.");
    m_operationCompletedMsg = xi18nc("@info:status", "Rollback of <application>Hg</application> repository completed successfully.");
...
{
    KConfig config(QStringLiteral("dolphin-hg"), KConfig::SimpleConfig, QStandardPaths::GenericConfigLocation);
